...
BLISS_TYPE_NAME := Bliss-Go
else
BLISS_TYPE_NAME := Bliss
endif
...
ifdef BLISS_RELEASE
    ...
    BLISS_BUILD_ZIP := $(BLISS_TYPE_NAME)-v$(VERSION)-$(BLISS_BUILD)-$(BLISS_BUILDTYPE)$(BLISS_SPECIAL_VARIANT)-$(BLISS_BUILD_VARIANT)-$(shell date +%Y%m%d)
endif
